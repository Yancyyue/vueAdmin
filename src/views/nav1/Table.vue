	...
	<section class="tablebox">
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" size="small" v-on:click="searchComm">查询</el-button>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" stripe style="width: 100%;">
			...
			<el-table-column prop="title" label="商品名" width="120" sortable>
			</el-table-column>
			<el-table-column prop="seriNum" label="编号" width="100" :formatter="formatSex" sortable>
			</el-table-column>
			<el-table-column prop="seriNum" label="货号" width="100" sortable>
			</el-table-column>
			<el-table-column label="图片" width="120">
				<template scope="scope">
					<img :src="scope.row.coverImg" width="50px" height="50px">
				</template>
			</el-table-column>
			...
			<el-table-column label="操作" width="150">
				<template scope="scope">
					...
					<el-button type="danger" icon="delete" size="small" @click="handleDel(scope.$index, scope.row)"></el-button>
				</template>
			</el-table-column>
		</el-table>
